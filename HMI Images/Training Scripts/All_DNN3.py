...
model_3a = Sequential()
model_3a.add(Conv2D(32, (3, 3), input_shape=shape,padding='same'))
model_3a.add(Activation('relu'))
model_3a.add(MaxPooling2D(pool_size=(2, 2)))
model_3a.add(Dropout(0.15))
...
model_3a.add(Dense(64))
model_3a.add(Activation('relu'))
model_3a.add(Dropout(0.15))
model_3a.add(Dense(3))
model_3a.add(Activation('sigmoid'))
